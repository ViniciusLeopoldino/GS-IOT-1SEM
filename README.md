...
[![Status](https://img.shields.io/badge/status-conclu%C3%ADdo-brightgreen)](https://github.com/SEU-USUARIO/SEU-REPOSITORIO)
...
### Software & Cloud
* Simulador de Hardware: **Wokwi** ([https://wokwi.com/](https://wokwi.com/))
* Gateway e Dashboard: **Node-RED** ([https://nodered.org/](https://nodered.org/))
* Protocolo de Comunicação: **MQTT** ([http://mqtt.org/](http://mqtt.org/))
* Broker MQTT: **HiveMQ Public Broker** ([https://www.hivemq.com/public-mqtt-broker/](https://www.hivemq.com/public-mqtt-broker/))
...
[![Wokwi Project](https://img.shields.io/badge/Wokwi-Projeto-blue)](https://wokwi.com/projects/432970311562255361)
*CLIQUE NO BADGE ACIMA PARA ACESSAR O SEU PROJETO DIRETAMENTE NO WOKWI.*

### Vídeo / GIF de Funcionamento
[![Demonstração do SMAE](https://img.shields.io/badge/Watch-Demo-orange)](https://placeholder.com/gif-link)
*COLE AQUI O SEU GIF OU LINK PARA O VÍDEO. UM GIF MOSTRANDO A INTERAÇÃO NO WOKWI E A ATUALIZAÇÃO NO DASHBOARD É IDEAL.*
